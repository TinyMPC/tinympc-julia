...
@testset "Settings Functionality" begin
    ...
    @testset "Adaptive Rho Settings" begin
        ...
        # Adaptive-rho solve currently requires sensitivity data to be generated
        # through the codegen path. This test only covers the settings binding.
        @test solver.is_setup[]
    end
